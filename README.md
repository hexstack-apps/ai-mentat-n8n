...
| Serve self-hosted N8N on domain via tunnel without VPS or risks | <a target="_blank" href="https://community.n8n.io/t/securely-self-hosting-n8n-with-docker-cloudflare-tunnel-the-arguably-less-painful-way/93801"><img src="https://n8n.io/favicon.ico" width="24" height="24" alt="n8n"></a> | 🌟 |
...
|------|------|
| **🌟PRO:** Expose the local running N8N to your domain via Cloudflare tunnel in 3-clicks GUI | ![N8N-Mentat app logo](./output.png) |
| **🌟PRO:** Setup and run MCP server for Your Claude code in 2 clicks and | ![N8N-Mentat app logo](./output.png) |
